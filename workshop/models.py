...
class Diagnostic(models.Model):
    ...
    details = models.TextField("Detalle diagnostico")
    created_at = models.DateTimeField(auto_now_add=True)
...
class RepairAction(models.Model):
    ...
    labor_rate = models.DecimalField("Tarifa por hora", max_digits=10, decimal_places=2, default=0)
    created_at = models.DateTimeField(auto_now_add=True)

    class Meta:
        verbose_name = "Actividad de reparacion"
        verbose_name_plural = "Actividades de reparacion"
