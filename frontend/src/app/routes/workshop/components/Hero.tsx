...
export default function Hero() {
  return (
    <header className="text-center py-12">
      ...
      <h1 className="mt-8 bg-gradient-to-r from-amber-200 via-amber-300 to-amber-100 bg-clip-text text-5xl md:text-6xl font-extrabold text-transparent drop-shadow-[0_0_22px_rgba(250,204,21,0.45)] vyc-title">
        Mantenimiento y Reparación de Vehículos
      </h1>

      <p className="mx-auto max-w-2xl text-lg text-cyan-100/80 mt-4">
